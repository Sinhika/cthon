...
@Mod.EventBusSubscriber(modid = Cthon.MODID,  bus = Mod.EventBusSubscriber.Bus.MOD)
public class ModEventSubscriber
{
    private static final Logger LOGGER = LogManager.getLogger(Cthon.MODID + " Mod Event Subscriber");
    ...
    public static void onRegisterRecipeSerializers(@Nonnull RegisterEvent event)
    {
        ...
        {
            CraftingHelper.register(new FlagCondition.Serializer(CthonConfig.INSTANCE, 
                    new ResourceLocation(Cthon.MODID, "flag")));
        }
