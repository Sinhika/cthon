    ...
    public static void gatherData(GatherDataEvent event)
    {
        ...
        gen.addProvider(event.includeServer(), 
            	new SimpleLootTableProvider(packOutput, List.of(
            			new LootTableProvider.SubProviderEntry(CthonLootTableSubprovider::new, LootContextParamSets.BLOCK),
                		new LootTableProvider.SubProviderEntry( CthonLootInjectorSubprovider::new, LootContextParamSets.CHEST)
                		)));
